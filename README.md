...
- **v29:** «مشخصات برگه (اختیاری)» از حالت آکاردئون به یک پنجره مودال واقعی (popup) تبدیل شد که بدون تغییر چیدمان کلی صفحه باز/بسته می‌شود؛ فیلد «باردار» بلافاصله قبل از «سن بیمار» قرار گرفت؛ راهنمای فیلد سن از داخل placeholder به یک متن کوچک زیر همان فیلد منتقل شد؛ جهت رابط کاربری اکنون در هر دو زبان همیشه و بدون استثنا روی LTR قفل است.
