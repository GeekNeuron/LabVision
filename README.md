...
پروژه LabVision یک ابزار آموزشی/اطلاعاتی است و توسط هیچ نهاد پزشکی تأیید نشده. محدوده‌های نرمال ارائه‌شده، بازه‌های عمومی است و ممکن است بین آزمایشگاه‌ها، دستگاه‌ها و روش‌های سنجش مختلف کمی متفاوت باشد — این تفاوت طبیعی و شناخته‌شده است، نه نشانه اشتباه. برخی رنج‌ها (مثل CK، LDH، یا اسید اوریک) حتی بین منابع پزشکی معتبر هم دقیقاً یکسان نیستند؛ در این موارد رنجی انتخاب شده که با بیشترین اجماع منابع همخوانی داشته باشد، نه لزوماً تنها عدد «درست». برای هرگونه تصمیم پزشکی، حتماً با پزشک یا متخصص آزمایشگاه مشورت کنید و رنج مرجع چاپ‌شده روی برگه آزمایش خودتان را نیز در نظر بگیرید.
